...
pub struct Request {
	...
	/// request.
	// TODO: is this the best syntax? this syntax means the errors generated by the request appear
	//       after the major and minor opcodes, simply separated by a comma. is this clearly
	//       showing that these are the errors?
	pub other_errors: Option<(Token![,], Type)>,
