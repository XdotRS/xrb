...
pub trait Request<REPLY = ()>: ToBytes {
...
requests! {
	...
	pub struct QueryTextExtends<'a>(48) -> QueryTextExtentsReply {
		pub $odd_length: bool,
		pub font: Fontable,
	...
	pub struct AllocColorCellsReply<'a> for AllocColorCells {
		#pixels,
		#masks,
		[(); 20],
		pub pixels: &'a [u32],
